...
$carga_hora = filter_input(INPUT_POST, 'Carga_hora', FILTER_SANITIZE_NUMBER_INT);
...
try {
  ...
  header("location:novo.php?id=$cod_disc&nome=$nome&carga_hora=$carga_hora&cod_prof=$cod_prof&erro=$erro");
  die();
}
